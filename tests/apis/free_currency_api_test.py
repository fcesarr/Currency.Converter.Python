...
from src.apis.free_currency_api import FreeCurrencyApi
from faker import Faker


class FreeCurrencyApiTest(unittest.TestCase):
    ...
    def test_get_codes(self):
        ...
        instance = FreeCurrencyApi(base_url="",
                                   endpoint_codes="",
                                   endpoint_latest="",
    ...
    def test_get_latest(self):
        ...
        self.assertEqual(instance.get_latest(codes=codes), latest_currency_data['data'])
